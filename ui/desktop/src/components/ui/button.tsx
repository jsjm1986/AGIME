...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm transition-all duration-200 cursor-pointer disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[1px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        ...
        gradient: 'bg-gradient-to-r from-block-teal to-block-orange text-white hover:opacity-90 shadow-md hover:shadow-lg hover:glow-brand',
        'ghost-glow': 'hover:bg-background-muted/50 hover:glow-soft dark:hover:bg-background-muted/30',
      },
      size: {
