...
export interface LoadingAgimeProps {
  message?: string;
  chatState?: ChatState;
}
...
const STATE_ICONS: Record<ChatState, React.ReactNode> = {
  ...
  [ChatState.Idle]: <AgimeLogo size="small" hover={false} />,
};

const LoadingAgime = ({ message, chatState = ChatState.Idle }: LoadingAgimeProps) => {
...
export default LoadingAgime;
export { LoadingAgime };

// Backward compatibility
export { LoadingAgime as LoadingGoose };
