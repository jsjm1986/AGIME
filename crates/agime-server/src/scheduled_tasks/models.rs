...
/// Desktop scheduled task — no MongoDB ObjectId, no team/channel fields.
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct ScheduledTaskDoc {
    pub task_id: String,
    /// Desktop: always the local session that created the task.
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub last_expected_fire_at: Option<DateTime<Utc>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
/// Desktop scheduled task run — no MongoDB ObjectId, no team/channel fields.
#[derive(Debug, Clone, Serialize, Deserialize)]
...
// ---------------------------------------------------------------------------
// Inference helpers (from team-server, no MongoDB dependency)
// ---------------------------------------------------------------------------
