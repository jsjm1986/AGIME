...
export const LEGACY_CONFIG_KEYS = {
  ...
  STREAM_FIRST_BYTE_TIMEOUT_MS: 'GOOSE_STREAM_FIRST_BYTE_TIMEOUT_MS',
  STREAM_IDLE_TIMEOUT_MS: 'GOOSE_STREAM_IDLE_TIMEOUT_MS',
  STREAM_MAX_RETRY_ATTEMPTS: 'GOOSE_STREAM_MAX_RETRY_ATTEMPTS',
} as const;
...
export const AGIME_CONFIG_KEYS = {
  ...
  STREAM_FIRST_BYTE_TIMEOUT_MS: 'AGIME_STREAM_FIRST_BYTE_TIMEOUT_MS',
  STREAM_IDLE_TIMEOUT_MS: 'AGIME_STREAM_IDLE_TIMEOUT_MS',
  STREAM_MAX_RETRY_ATTEMPTS: 'AGIME_STREAM_MAX_RETRY_ATTEMPTS',
} as const;
