//! Workspace runtime helpers (path validation, scanning, snapshots).
//!
//! SOURCE: crates/agime-team-server/src/agent/workspace_runtime.rs at commit
//! 961109f. Verbatim copy. Pure-logic helpers — no Mongo / TeamAgent
//! coupling, so the team-side and desktop-side bodies can stay
//! bit-for-bit identical until they consciously diverge.
//!
