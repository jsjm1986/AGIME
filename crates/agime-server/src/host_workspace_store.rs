//! Workspace physical-store trait and local-FS implementation.
//!
//! SOURCE: combined verbatim from
//! `crates/agime-team-server/src/agent/workspace_physical_store.rs` and
//! `crates/agime-team-server/src/agent/local_fs_workspace_store.rs` at
...
use super::host_workspace_types::{
