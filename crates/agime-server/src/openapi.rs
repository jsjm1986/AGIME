use agime::agents::extension::Envs;
...
use agime::config::declarative_providers::{
...
#[openapi(
    paths(
        ...
        super::routes::agent::set_session_override,
        super::routes::agent::clear_session_override,
        super::routes::agent::delete_session_override,
        ...
        super::routes::config_management::set_thinking_config,
        super::routes::config_management::get_pricing,
        super::routes::config_management::get_system_prompt,
    ...
    components(schemas(
        ...
        super::routes::config_management::CapabilitiesResponse,
        super::routes::config_management::CapableModelsResponse,
        super::routes::config_management::ThinkingConfigResponse,
        super::routes::config_management::SetThinkingConfigRequest,
        ...
        super::routes::config_management::PromptResponse,
        super::routes::config_management::SetCustomPromptRequest,
        super::routes::config_management::DefaultPromptsResponse,
        super::routes::config_management::PromptTemplate,
        super::routes::action_required::ConfirmToolActionRequest,
        super::routes::reply::ChatRequest,
        super::routes::session::ImportSessionRequest,
        super::routes::session::UpdateSessionMetadataRequest,
        super::routes::session::SessionMetadataResponse,
        super::routes::session::AllTagsResponse,
        super::routes::session::SessionListResponse,
        super::routes::session::ListSessionsQuery,
        super::routes::session::PaginatedSessionListResponse,
        ...
        Conversation,
        IconSchema,
        agime::session::extension_data::ExtensionData,
        ...
        agime::recipe::Recipe,
        agime::recipe::Author,
        agime::recipe::Settings,
        agime::recipe::RecipeParameter,
        agime::recipe::RecipeParameterInputType,
        agime::recipe::RecipeParameterRequirement,
        agime::recipe::Response,
        agime::recipe::SubRecipe,
        agime::agents::types::RetryConfig,
        agime::agents::types::SuccessCheck,
        ...
        super::routes::agent::SessionOverrideRequest,
        super::routes::agent::ClearSessionOverrideRequest,
        super::host_provider::HostProviderConfig,
        super::host_provider::HostApiFormat,
        super::host_provider::HostRuntimeOptimizationMode,
        super::host_workspace::WorkspaceExecutionContext,
        super::host_workspace::WorkspaceKind,
        super::host_prompt::PromptApprovalMode,
        super::host_prompt::PromptCapabilitySnapshot,
        super::host_prompt::PromptHarnessOverlay,
        super::host_prompt::PromptSurfaceContract,
