...
use agime::scheduler::ScheduledJob;
...
async fn create_schedule(
    ...
    scheduler
        ...
        .map_err(|e| {
            ...
            match e {
                agime::scheduler::SchedulerError::JobNotFound(_) => StatusCode::NOT_FOUND,
                agime::scheduler::SchedulerError::CronParseError(_) => StatusCode::BAD_REQUEST,
                agime::scheduler::SchedulerError::RecipeLoadError(_) => StatusCode::BAD_REQUEST,
                agime::scheduler::SchedulerError::JobIdExists(_) => StatusCode::CONFLICT,
...
async fn run_now_handler(
    ...
    match scheduler.run_now(&id).await {
        ...
        Err(e) => {
            ...
            match e {
                agime::scheduler::SchedulerError::JobNotFound(_) => Err(StatusCode::NOT_FOUND),
                agime::scheduler::SchedulerError::AnyhowError(ref err) => {
...
async fn pause_schedule(
    ...
    scheduler.pause_schedule(&id).await.map_err(|e| {
        ...
        match e {
            agime::scheduler::SchedulerError::JobNotFound(_) => StatusCode::NOT_FOUND,
            agime::scheduler::SchedulerError::AnyhowError(_) => StatusCode::BAD_REQUEST,
            _ => StatusCode::INTERNAL_SERVER_ERROR,
        }
    })?;
    Ok(StatusCode::NO_CONTENT)
